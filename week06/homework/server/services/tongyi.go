...
func (c *TongyiClient) Generate(ctx context.Context, req config.QuestionRequest) (*config.QuestionResponse, error) {
...
func parseTongyiResponse(content string) (*config.QuestionResponse, error) {
